...
const SURF_SHOP_CONSTANTS = {
    API: {
        ...
        ADMIN_NOTIFICATIONS_COUNT:  '/api/admin/notifications/count',
        ADMIN_NOTIFICATIONS_READ_ALL: '/api/admin/notifications/read-all',
        ADMIN_NOTIFICATION_READ: (id) => `/api/admin/notifications/${id}/read`,
        ADMIN_EXPIRY_DASHBOARD: '/api/admin/expiry-dashboard',
        MEMBER_MY_LESSONS:       '/api/members/my-lessons',
        MEMBER_MY_WAITLIST:      '/api/members/my-waitlist',
